...
This project was meticulously carried out, and various processes were documented in git. And it successfully built and ran the pipeline with the model from end to end.

## Project Links
My GitHub - https://github.com/datamillers/Project-Build-an-ML-Pipeline-Starter.git

My Weight & Biases project - https://wandb.ai/datamillersrichmond-western-governors-university/nyc_airbnb?nw=nwuserdatamillersrichmond
...
```
git clone https://github.com/datamillers/Project-Build-an-ML-Pipeline-Starter.git
```
